...
const Login=()=>{
    ...
    const handleLogin =()=>{
        ...
        if(myUsers){
            ...
            // localStorage.setItem("loginDataPastor", JSON.stringify(pastorInfo))
            navigate("/home") 
        }else{
    ...
    return(
        <div className='login-wrapper'>
            ...
            <div className='login-body'>
                ...
                <div className='pastor' onClick={handleLoginPastor}><h4>dont have an account? SignUp</h4></div>
            </div>
        </div>
    )
}
